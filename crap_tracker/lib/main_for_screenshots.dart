// This is a copy of main.dart with debug banner disabled for screenshots
// To use: 
// 1. Save your original main.dart if needed: cp lib/main.dart lib/main_original.dart
// 2. Copy this file to main.dart: cp lib/main_for_screenshots.dart lib/main.dart
// 3. Take screenshots
// 4. Restore original if needed: cp lib/main_original.dart lib/main.dart
    ...
    return MultiProvider(
      ...
      child: Consumer<ThemeProvider>(
        builder: (context, themeProvider, _) => MaterialApp(
          ...
          debugShowCheckedModeBanner: false, // Remove debug banner for screenshots
        ),
      ),
    );
  }
...
class ErrorApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      debugShowCheckedModeBanner: false, // Also remove from error screen
      home: Scaffold(
        appBar: AppBar(
